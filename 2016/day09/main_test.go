...
func TestPart2(t *testing.T) {
	if have, want := DecompressedLength2(`(3x3)XYZ`), 9; have != want {
		t.Errorf("have %v, want %v", have, want)
	}

	if have, want := DecompressedLength2(`X(8x2)(3x3)ABCY`), 20; have != want {
		t.Errorf("have %v, want %v", have, want)
	}

	if have, want := DecompressedLength2(`(27x12)(20x12)(13x14)(7x10)(1x12)A`), 241920; have != want {
		t.Errorf("have %v, want %v", have, want)
	}

	if have, want := DecompressedLength2(`(25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN`), 445; have != want {
		t.Errorf("have %v, want %v", have, want)
	}
}
